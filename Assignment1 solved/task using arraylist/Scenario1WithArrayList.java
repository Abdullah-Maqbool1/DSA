...
class OrderManagementSystem {
    ...
    public void addOrder(Order order) { // ~~> take O(n) time complexity because shifting required!
        ordersList.addFirst(order); // inserting at first insert (implementing FIFO)
...
public class Scenario1WithArrayList {
